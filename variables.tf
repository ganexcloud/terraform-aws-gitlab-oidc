...
variable "url" {
  description = "GitLab OpenID URL. The address of your GitLab instance, such as https://gitlab.com or http://gitlab.example.com."
  type        = string
...
variable "tls_certificate_url" {
  ...
  type        = string
  default     = "https://gitlab.com/oauth/discovery/keys"
}
...
variable "oidc_provider_arn" {
  description = "If create_oidc_provider is false configure OpenID provider ARN."
  type        = string
  default     = null
}

variable "oidc_provider_url" {
  description = "If create_oidc_provider is false configure OpenID provider URL."
  type        = string
  default     = null
}
